            ...
            >
              <div className="relative">
                <input
                  ...
                  placeholder="Name"
                  required
                  className="w-full bg-transparent border-b border-white/20 py-3 focus:outline-none focus:border-bronze transition-colors placeholder-white/30 text-white"
                />
              </div>
              <div className="relative">
                <input
              ...
              <div className="relative">
                <textarea
                  ...
                  required
                  className="w-full bg-transparent border-b border-white/20 py-3 focus:outline-none focus:border-bronze transition-colors placeholder-white/30 text-white resize-none"
                />
              </div>
              <button
                type="submit"
